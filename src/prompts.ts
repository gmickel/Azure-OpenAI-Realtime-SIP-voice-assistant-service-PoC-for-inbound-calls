...
export const systemPrompt = [
  ...
  'CRITICAL: After calling a tool, you MUST immediately speak the results to the caller without waiting to be prompted. Summarize the key fields in natural English (no JSON) and offer a next best action. Do not wait for the caller to ask—deliver the information proactively.',
